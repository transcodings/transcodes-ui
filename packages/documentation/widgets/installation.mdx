...
<Card title="Storybook에서 보기" href="https://transcodes-ui-storybook.vercel.app/?path=/story/widgets-tc-installation-banner" icon="external-link">
...
<template>
  <div>
    <button @click="openGuide">설치 방법</button>
...
<Card title="Storybook에서 보기" href="https://transcodes-ui-storybook.vercel.app/?path=/story/widgets-tc-ios-installation-guide" icon="external-link">
  Storybook에서 모든 상태를 확인할 수 있습니다.
</Card>
